...
export default function All() {
    ...
    const [items, setItems] = useState([
        { id: 1, image: "/src/imgShopAll/4.jpg", title: "Cool Weave", description: "Anywhere Dress", price: "$210", isNew: true },
        { id: 2, image: "/src/imgShopAll/3.jpg", title: "Cool Weave", description: "Anywhere Dress", price: "$210", isNew: false },
        { id: 3, image: "/src/imgShopAll/7.jpg", title: "Cool Weave", description: "Anywhere Dress", price: "$210", isNew: true },
    ]);
    ...
    const loadMoreItems = () => {
        ...
        setTimeout(() => {           
            const newItems = [
                { id: 4, image: "/src/imgShopAll/5.jpg", title: "New Item", description: "New Dress", price: "$250", isNew: true },
                { id: 5, image: "/src/imgShopAll/6.jpg", title: "Old Item", description: "Old Dress", price: "$250", isNew: false },
            ];
    ...
    return (
        <div>
            ...
            <img src="/src/imgShopAll/1.jpg" className="w-full my-5" alt="" />
