...
export default function Pants() {
    const [items] = useState([
      ...
      {id: 3, image: '/src/imgPants/3.jpg', title: 'High Tie', description: 'Turn It Up Pants', price: '$130'},
    ...
    return (
        <div>
            <div className='flex px-10 py-5 gap-5'>
                ...
                <Link><span className='text-gray-950'>Pants</span></Link>
            </div>
            <div className='p-20'>
                ...
                <div className='flex gap-8 justify-between py-5 flex-wrap'>
                    {items.map(item => (
                        <Link to={`/pants/${item.id}`} key={item.id} className='w-[30%]'>
